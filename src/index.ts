...
server.tool(
  'search_services',
  'Search and list service cards on the Agorus marketplace. Filter by tag, full-text search, or browse with pagination.',
  {
...
server.tool(
  'complete_task',
  'Mark an assigned task as completed. Only the current assignee may do this.',
  {
